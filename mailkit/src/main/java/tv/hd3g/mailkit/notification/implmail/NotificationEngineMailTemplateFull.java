...
public class NotificationEngineMailTemplateFull implements NotificationMailMessageProducer {

	private final NotificationMailTemplateToolkit toolkit;

	public NotificationEngineMailTemplateFull(final NotificationMailTemplateToolkit toolkit) {
	...
	private HtmlCssDocumentPayload assembleHTMLMessageBodyContent(final Locale lang,
		...
		if (event.error() != null) {
			toolkit.makeDocumentTitleError(lang, event, listBodyContent, true, false);
		}
