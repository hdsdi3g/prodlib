...
class NotificationEngineMailTemplateDebugTest {
	...
	void testMakeMessage_Error_noResult_noSteps() {
		...
		verify(toolkit, times(1)).makeDocumentTitleError(lang, event, listBodyContent, true, true);
	}
	...
	void testMakeMessage_noError_Result_noSteps() {
		...
		verify(toolkit, times(1)).makeDocumentCallers(lang, event, listBodyContent, listCSSEntries);
	}
	...
	void testMakeMessage_noError_noResult_Steps() {
		...
		verify(toolkit, times(1)).makeDocumentTitleWithoutResult(lang, event, listBodyContent);
		verify(toolkit, times(1)).stepsList(lang, event, true, listBodyContent, listCSSEntries);
	}
